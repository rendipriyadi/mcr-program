...
@section('content')
	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
			<p>
				Add the <code>.app-with-end-sidebar</code> css class to <code>.app</code> container for right sidebar page setting.
			</p>
		</div>
		<div class="hljs-wrapper">
			<pre><code class="html">&lt;div id="app" class="app app-with-end-sidebar"&gt;
  ...
&lt;/div&gt;</code></pre>
		</div>
	</div>
