		...
		<div class="col-xl-8">
			...
			<div class="panel panel-inverse" data-sortable-id="form-slider-switcher-1">
				...
				<div class="panel-body">
					<div>
						<p>
							You can use the predefined javascript variable in <code>/assets/js/theme/</code> folder to create different color theme switchery.
						</p>
...
&lt;/script&gt;</code></pre>
		...
		<div class="col-xl-4">
			...
			<div class="panel panel-inverse" data-sortable-id="form-slider-switcher-3">
				...
				<!-- BEGIN hljs-wrapper -->
				<div class="hljs-wrapper">
					<pre><code class="html">&lt;!-- change state via javascript --&gt;
&lt;script&gt;
...
&lt;/script&gt;</code></pre>
	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
			<p>
				You can use the predefined javascript variable in <code>/assets/js/theme/</code> folder to create different color theme switchery. You may add the <code>hideRange</code> option and set the value as <code>true</code>
