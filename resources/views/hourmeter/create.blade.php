...
<div class="card-body">
   <form action="{{ route('hourmeter.store') }}" class="" method="post">
    @csrf
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        @enderror" name="example-text-input" placeholder="Input Date" value="{{ old('datehm') }}">
        @error('datehm')
      ...
      @enderror
          ...
          <div class="mb-3">
            ...
            <input name="nikopthm" class="form-control" id="optnik" placeholder="NIK Operator" readonly>
        </div>
      ...
      @enderror" id="modelunit" placeholder="Model" value="{{ old('modelhm') }}" readonly>
      @error('modelhm')
      ...
      @enderror" id="hmawal" placeholder="Input Hourmeter Start" value="{{ old('hmawal') }}">
      @error('hmawal')
      ...
      <div class="mb-3">
        ...
        @enderror" id="hmakhir" placeholder="Input Hourmeter End" value="{{ old('hmakhir') }}">
        @error('hmakhir')
      ...
      @enderror" id="totalhm" placeholder="Input Total" value="{{ old('totalhm') }}" readonly>
      @error('totalhm')
      ...
      @enderror" name="example-text-input" placeholder="Input Remark" value="{{ old('remarkhm') }}">
      @error('remarkhm')
