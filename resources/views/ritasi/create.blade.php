...
<div class="card-body">
   <form action="{{ route('ritasi.store') }}" class="" method="post">
    @csrf
      ...
      <div class="col-sm-3">
       <strong>Date</strong>
        ...
        @enderror" placeholder="Input Date" value="{{ old('ritasidate') }}">
        @error('ritasidate')
      ...
      <div class="mb-3">
       <strong>Site</strong>
        ...
        <select class="form-select  @error('site')
  ...
  @enderror
      ...
      <div class="mb-3">
        ...
        <input name="shift" class="form-control " id="shift" placeholder="Shift" readonly>
  </div>
  <div class="mb-3">
  ...
  @enderror
      ...
      <div class="mb-3">
        ...
        <label for="nikloader">NIK Loader </label>
        <input name="nikloader" class="form-control" id="optnik" placeholder="NIK Loader" readonly>
    </div>
      ...
      @enderror" id="optnikhauler" placeholder="NIK Hauler" value="{{ old('optnik') }}" readonly>
      @error('optnik')
      ...
      @enderror" value="{{ old('codeloader') }}" readonly>
      @error('codeloader')
      ...
      @enderror
            ...
            <option value="{{ $loader }}" data-modelunit="{{ $loader->modelunit }}">{{ $loader->codeunit }}</option>
            @endforeach
            ...
            <script>
                function selectLoader() {
                    ...
                    let model_loader = document.getElementById('modelunit');

                    if (select.value === 'default') {
                        model_loader.value = '';
                    } else {
                        let selectedLoader = select.options[select.selectedIndex];
                        model_loader.value = selectedLoader.dataset.modelunit;
                    }
              }
          </script>
           </select>
      ...
      @enderror"  id="modelunit" placeholder="Model Loader" value="{{ old('modelloader') }}" readonly>
      @error('modelloader')
      ...
      @enderror"  value="{{ old('codehauler') }}" readonly>
      @error('codehauler')
      ...
      @enderror
            ...
            <option value="{{ $hauler}}" data-modelunit="{{ $hauler->modelunit }}" data-truckfactor="{{ $hauler->truck_factor }}">{{ $hauler->codeunit }}</option>
            @endforeach
            ...
            <script>
                function selectHauler() {
                    ...
                    let model_hauler = document.getElementById('modelunit_hauler');
                    let truck_factor = document.getElementById('truck_factor');

                    if (select.value === 'default') {
                        model_hauler.value = '';
                        truck_factor.value = '';
                    } else {
                        let selectedHauler = select.options[select.selectedIndex];
                        model_hauler.value = selectedHauler.dataset.modelunit;
                        truck_factor.value = selectedHauler.dataset.truckfactor;
                    }
              }
          </script>
          </select>
      ...
      @enderror"  id="modelunit_hauler" placeholder="Model Hauler"  value="{{ old('modelhauler') }}" readonly>
      @error('modelhauler')
      ...
      <div class="mb-3">
        <label for="truck_factor">Factor Truck</label>
        <input type="text" name="factortruck" class="form-control @error('factortruck')

        is-invalid

      @enderror"  id="truck_factor" placeholder="Factor Truck" onkeyup="function()"  value="{{ old('factortruck') }}" readonly>
      @error('factortruck')
      ...
      <div class="mb-3">
        ...
        <select id="block-select" onchange="selectLocation()" name="block" class="form-control">
      ...
      <input name="pit" class="form-control" id="pit" placeholder="PIT" readonly>
      </div>
      <div class="mb-3">
        <label for="submaterial-select">Sub Material</label>
        <select id="submaterial-select" onchange="selectMaterial()" name="submaterial" class="form-control">
      ...
      <div class="mb-3">
        ...
        <input name="material" class="form-control" id="material" placeholder="Material" readonly>

      </div>
      <div class="mb-3">
        <label for="factor">Factor Material</label>
        <input type="text"name="factor" class="form-control" id="factor" placeholder="Factor Material" readonly>
      ...
      @enderror" id="ritase" placeholder="Input Ritase"  onkeyup="function()" value="{{ old('ritase') }}" >
      @error('ritase')
      ...
      <div class="mb-3">
        ...
        @enderror" id="distance" placeholder="Input Distance" value="{{ old('distance') }}">
        @error('distance')
      ...
      <div class="mb-3">
          ...
          @enderror" id="produksi" placeholder="Input Produksi" onkeyup="function()"  value="{{ old('produksi') }}" readonly>
          @error('produksi')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#truck_factor, #ritase").keyup(function() {
                    var ritase  = $("#ritase").val();
                    var truck_factor = $("#truck_factor").val();
                    ritase = ritase.replace(",", ".");
                    truck_factor = truck_factor.replace(",", ".");

                    var produksi = (parseFloat(ritase)*parseFloat(truck_factor));
        ...
        @enderror" id="adjustment" placeholder="Input Adjustment" value="{{ old('adjustment') }}" readonly>
        @error('adjustment')
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#truck_factor, #ritase, #factor").keyup(function() {
                    var ritase  = $("#ritase").val();
                    var truck_factor = $("#truck_factor").val();
                    ...
                    var adjustment = (parseFloat(ritase)*parseFloat(truck_factor)*parseFloat(factor));
        ...
        <div class="mb-3">
          ...
          @enderror" id="distvol" placeholder="Input Dist*Vol" value="{{ old('distvol') }}" readonly>
          @error('distvol')
        ...
        <div class="mb-3">
          ...
          @enderror" placeholder="Input Factor" value="{{ old('factor') }}">
        ...
        <div class="mb-3">
          ...
          @enderror" name="example-text-input" placeholder="Input Detail" value="{{ old('detail') }}">
          @error('detail')
        ...
        @enderror" name="example-text-input" placeholder="Input Dumping" value="{{ old('dumping') }}">
        @error('dumping')
