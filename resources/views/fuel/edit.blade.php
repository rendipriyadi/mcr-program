...
<div class="card-body">
   <form action="{{ route('fuel.update',$fuel->id) }}" class="" method="post">
    @csrf
@method('PUT')
    <div class="mb-3">
        <label class="form-label">Site</label>
        <input class="form-control" id="site-option" name="sitecode" value="{{ old('sitecode') ?? $fuel->sitecode }}" readonly>
      ...
      <div class="mb-3">
        ...
        @enderror" id="fueldate" placeholder="Input Date" value="{{ old('fueldate') ?? $fuel->fueldate}}">
        @error('fueldate')
      ...
      <div class="mb-3">
        ...
        <select class="form-control" id="shift-option" name="shiftcode" value="{{ old('shiftcode') ?? $fuel->shiftcode }}">
      ...
      @enderror"  value="{{ old('fuelcnunit') ?? $fuel->fuelcnunit }}">
      @error('fuelcnunit')
      ...
      @enderror" id="type" placeholder="Type"  value="{{ old('typecode') ?? $fuel->typecode }}" readonly>
      @error('typecode')
      ...
      @enderror" id="modelunit" placeholder="Model" value="{{ old('fuelmodel') ?? $fuel->fuelmodel }}" readonly>
      @error('fuelmodel')
      ...
      @enderror" id="hmbefore" placeholder="Input Hourmeter Before" value="{{ old('hmbefore') ?? $fuel->hmbefore }}">
      @error('hmbefore')
      ...
      <div class="mb-3">
        ...
        @enderror" id="hmstart" placeholder="Input Hourmeter Start" value="{{ old('hmstart') ?? $fuel->hmstart }}">
        @error('hmstart')
      ...
      @enderror" id="fueltotal" placeholder="Input Total" value="{{ old('fueltotal') ?? $fuel->fueltotal }}" readonly>
      @error('fueltotal')
      ...
      @enderror" id="fuelusage" placeholder="Input Fuel Usage" value="{{ old('fuelusage') ?? $fuel->fuelusage}}">
      @error('fuelusage')
      ...
      @enderror" id="fuelcons" placeholder="Input Fuel Cons" value="{{ old('fuelcons') ?? $fuel->fuelcons }}" readonly>
      @error('fuelcons')
      ...
      @enderror" id="fuelob" placeholder="Input Fuel OB" value="{{ old('fuelob') ?? $fuel->fuelob}}">
      @error('fuelob')
      ...
      @enderror" id="fuelcoal" placeholder="Input Fuel Coal" value="{{ old('fuelcoal') ?? $fuel->fuelcoal}}">
      @error('fuelcoal')
      ...
      @enderror" id="fuelcoaltransport" placeholder="Input Fuel Coal" value="{{ old('fuelcoaltransport') ?? $fuel->fuelcoaltransport }}">
      @error('fuelcoaltransport')
