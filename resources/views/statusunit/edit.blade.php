...
<div class="card-body">
   <form action="{{ route('statusunit.update',$statusunit->id) }}" class="" method="post">
    @csrf
@method('PUT')
    ...
    <div class="mb-3">
      <div class="col-sm-3">
        ...
        @enderror"  placeholder="Input Date" value="{{ old('statusunitdate') ?? $statusunit->statusunitdate }}">
        @error('statusunitdate')
      ...
      <div class="mb-3">
        ...
        <input class="form-control  @error('site')

        is-invalid

      @enderror" name="sitecode" value="{{ old('site') ?? $statusunit->sitecode}}" readonly>
      @error('site')
      ...
      @enderror  value="{{ old('statusopt') ?? $statusunit->statusopt}}">
      @error('statusopt')
      ...
      <div class="mb-3">
        ...
        <input name="statusnikopt" class="form-control" id="optnik" placeholder="NIK Operator" value="{{ old('statusniopt') ?? $statusunit->statusnikopt }}" readonly>
      </div>
      <div class="mb-3">
      ...
      @enderror">
            ...
            <script>
              function selectEquipment() {
                  ...
                  let status_model = document.getElementById('codemodelhauler');

                  if(select.value === 'default') {
                      status_model.value = '';
                  } else {
                      status_model.value = JSON.parse(select.value).codemodelhauler;
                  }
              }
          </script>
      </div>
      <div class="mb-3">
        ...
        <input name="statusmodel" class="form-control" id="codemodelhauler" placeholder="Model" value="{{ old('statusmodel') ?? $statusunit->statusmodel}}" readonly>
      </div>
      ...
      <div class="mb-3">
        ...
        <input name="statuscategory" class="form-control" id="categori" placeholder="Category" value="{{ old('statuscategory') ?? $statusunit->statuscategory }}">
      </div>
      <div class="mb-3">
        ...
        @enderror " id="statusstart" placeholder="Input Start" value="{{ old('statusstart') ?? $statusunit->statusstart }}">
      ...
      <div class="mb-3">
        ...
        @enderror" id="statusend" placeholder="Input End" value="{{ old('statusend') ?? $statusunit->statusend }}">
        @error('statusend')
      ...
      <div class="mb-3">
        ...
        @enderror" id="statushour" placeholder="Input Total" value="{{ old('statushour') ?? $statusunit->statushour }}" readonly>
        @error('statushour')
    ...
    @enderror" name="dedicated" value="{{ old('dedicated') ?? $statusunit->dedicated }}">
    @error('dedicated')
    ...
    @enderror
      ...
      <div class="mb-3">
        ...
        @enderror" placeholder="Input Remark" value="{{ old('remark') ?? $statusunit->statusremark }}">
        @error('remark')
      ...
      <div class="mb-3">
        ...
        <select class="form-control" id="shift-option" name="statusshift" value="{{ old('statusshift') ?? $statusunit->statusshift }}">
      ...
      <div class="mb-3">
        ...
        @enderror" placeholder="Input Kode" value="{{ old('kode') ?? $statusunit->statuscode }}">
        @error('kode')
