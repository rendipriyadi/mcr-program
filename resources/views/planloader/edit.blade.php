...
@php
    ...
    $title ="Edit Plan Performance Loader";
    $preTitle ="";
...
<div class="card-body">
   <form action="{{ route('planloader.update', $planloader->id) }}" class="" method="post">
    @csrf
    @method('PUT')
    <div class="form-row">
        ...
        <div class="col-sm-3">
          ...
          @enderror" name="sitecode" value="{{ old('sitecode') ?? $planloader->sitecode }}" readonly>
          @error('sitecode')
        ...
        <div class="sm-3">
            ...
            @enderror " name="example-text-input" placeholder="Input NIK" value="{{ old('tanggal_planloader') ?? $planloader->tanggal_planloader }}">
        ...
        <div class="col-sm-3">
          ...
          @enderror" name="codemodelloader" value="{{ old('codemodelloader') ?? $planloader->codemodelloader }}">
          ...
          @enderror"  id="qty_planloader" placeholder="Input Qty" value="{{ old('qty_planloader') ?? $planloader->qty_planloader }}">
          @error('qty_planloader')
          ...
          @enderror" id="pa_planloader" placeholder="Input PA" value="{{ old('pa_planloader') ?? $planloader->pa_planloader }}">
          @error('pa_planloader')
          ...
          @enderror"  id="ua_planloader" placeholder="Input UA" value="{{ old('ua_planloader') ?? $planloader->ua_planloader }}">
          @error('ua_planloader')
          ...
          @enderror" id="pty_planloader" placeholder="Input Pty" value="{{ old('pty_planloader') ?? $planloader->pty_planloader }}">
          @error('pty_planloader')
          ...
          @enderror" id="mohh_planloader" placeholder="Input Produksi" value="{{ old('mohh_planloader') ?? $planloader->mohh_planloader }}">
          @error('mohh_planloader')
          ...
          @enderror"  id="prod_loaderob" placeholder="Input Produksi Loader OB" value="{{ old('prod_loaderob') ?? $planloader->prod_loaderob }}" readonly>
          @error('prod_loaderob')
