...
<div class="card-body">
   <form action="{{ route('planhauler.update', $planhauler->id) }}" class="" method="post">
    @csrf
    @method('PUT')
    <div class="form-row">
        ...
        <div class="col-sm-3">
          ...
          @enderror" name="sitecode" value="{{ old('sitecode') ?? $planhauler->sitecode }}" readonly>
          @error('sitecode')
        ...
        <div class="sm-3">
            ...
            @enderror " name="example-text-input" placeholder="Input NIK" value="{{ old('tanggal_planhauler') ?? $planhauler->tanggal_planhauler }}">
        ...
        <div class="mb-3">
          ...
          @enderror" name="codemodelhauler" value="{{ old('codemodelhauler') ?? $planhauler->codemodelhauler }}">
          ...
          @enderror" id="qty_planhauler" placeholder="Input Qty" value="{{ old('qty_planhauler') ?? $planhauler->qty_planhauler }}">
          @error('qty_planhauler')
          ...
          @enderror" id="pa_planhauler" placeholder="Input PA" value="{{ old('pa_planhauler') ?? $planhauler->pa_planhauler }}">
          @error('pa_planhauler')
          ...
          @enderror" id="ua_planhauler" placeholder="Input UA" value="{{ old('ua_planhauler') ?? $planhauler->ua_planhauler }}">
          @error('ua_planhauler')
          ...
          @enderror" id="pty_planhauler" placeholder="Input Pty" value="{{ old('pty_planhauler') ?? $planhauler->pty_planhauler }}">
          @error('pty_planhauler')
          ...
          @enderror" id="mohh" placeholder="Input Produksi" value="{{ old('mohh') ?? $planhauler->mohh }}">
          @error('mohh')
          ...
          @enderror" id="prod_haulerob" placeholder="Input Produksi Hauler OB" value="{{ old('prod_haulerob') ?? $planhauler->prod_haulerob }}" readonly>
          @error('prod_haulerob')
