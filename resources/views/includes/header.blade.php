...
<div id="header" class="app-header {{ $appHeaderClass }}">
	...
	<div class="navbar-nav">
		...
		<div class="navbar-item dropdown">
			...
			@include('templating.includes.component.header-dropdown-notification')
		</div>

		@isset($appHeaderLanguageBar)
			@include('templating.includes.component.header-language-bar')
		@endisset
		...
		<div class="navbar-item navbar-user dropdown">
			...
			@include('templating.includes.component.header-dropdown-profile')
		</div>
