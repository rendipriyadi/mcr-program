...
<div class="card-body">
   <form action="{{ route('breakdown.update', $breakdown->id) }}" class="" method="post">
    @csrf
@method('PUT')
    <div class="mb-3">
    ...
    @enderror" name="sitecode" value="{{ old('sitecode') ?? $breakdown->sitecode }}" readonly>
    @error('sitecode')
    ...
    @enderror" name="breakshift" value="{{ old('shiftcode') ?? $breakdown->breakshift }}">
    @error('shiftcode')
    ...
    @enderror
      ...
      <div class="mb-3">
        ...
        @enderror" placeholder="Input Date" value="{{ old('breakdate') ?? $breakdown->breakdate }}">
        @error('breakdate')
      ...
      @enderror"  id="type" placeholder="Input Break Type"  value="{{ old('breaktype') ??$breakdown->breaktype }}" readonly>
      @error('breaktype')
      ...
      @enderror"  id="modelunit" placeholder="Input Break Model"  value="{{ old('breakmodel') ?? $breakdown->breakmodel }}" readonly>
      @error('breakmodel')
      ...
      @enderror" id="bdawal" placeholder="Input Jam Awal B/D" value="{{ old('bdawal') ?? $breakdown->bdawal }}">
      @error('bdawal')
      ...
      <div class="mb-3">
        ...
        @enderror" id="bdakhir" placeholder="Input Jam Akhir B/D" value="{{ old('bdakhir') ?? $breakdown->bdakhir }}">
        @error('bdakhir')
      ...
      @enderror" id="breaktotal" placeholder="Input Total (Hours)" value="{{ old('breaktotal') ?? $breakdown->breaktotal}}" readonly>
      @error('breaktotal')
      ...
      @enderror" placeholder="Input Status" value="{{ old('breakstatus') ?? $breakdown->breakstatus}}">
      @error('breakstatus')
      ...
      <div class="mb-3">
        ...
        @enderror"  placeholder="Input BD Description" value="{{ old('bddesc') ?? $breakdown->bddesc }}">
        @error('bddesc')
